...
train_label = np_utils.to_categorical(train[:,-1]-1,nb_classes=4)
train = train[:,:-1]
(trX,teX,trY,teY) = train_test_split(train,train_label,test_size=0.1)
...
#Training
model.fit(trX, trY, batch_size=5, nb_epoch=10*nb_epoch,
